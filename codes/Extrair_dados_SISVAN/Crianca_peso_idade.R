...
crianca_peso_idade <- function(ano){
  ...
  file_name <- paste("C:/Users/Carlos Garcia Filho/OneDrive/Documentos/Unifor/Dados_Secundarios/Pesquisa_SISVAN/Dados/criancas_peso_idade",as.character(y),".csv", collapse = NULL) 
...
sapply(periodo, crianca_peso_idade)