...
crianca_peso_altura <- function(ano){
  ...
  filled_form <- set_values(filled_form, "nu_indice_cri" = "2")
  ...
  file_name <- paste("C:/Users/Carlos Garcia Filho/OneDrive/Documentos/Unifor/Dados_Secundarios/Pesquisa_SISVAN/Dados/criancas_peso_altura",as.character(y),".csv", collapse = NULL) 
...
sapply(periodo, crianca_peso_altura)