...
adolescente_IMC_idade <- function(ano){
  ...
  filled_form <- set_values(filled_form, "nu_indice_ado" = "2")
  ...
  file_name <- paste("C:/Users/Carlos Garcia Filho/OneDrive/Documentos/Unifor/Dados_Secundarios/Pesquisa_SISVAN/Dados/adolescentes_IMC_idade",as.character(y),".csv", collapse = NULL) 
...
sapply(periodo, adolescente_IMC_idade)