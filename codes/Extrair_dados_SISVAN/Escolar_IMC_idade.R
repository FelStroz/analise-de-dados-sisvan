...
escolar_IMC_idade <- function(ano){
  ...
  file_name <- paste("C:/Users/Carlos Garcia Filho/OneDrive/Documentos/Unifor/Dados_Secundarios/Pesquisa_SISVAN/Dados/escolares_IMC_idade",as.character(y),".csv", collapse = NULL) 
...
sapply(periodo, escolar_IMC_idade)