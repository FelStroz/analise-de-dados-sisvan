...
gestante <- function(ano){
  ...
  filled_form <- set_values(filled_form, "nu_ciclo_vida" = "5")
  ...
  file_name <- paste("C:/Users/Carlos Garcia Filho/OneDrive/Documentos/Unifor/Dados_Secundarios/Pesquisa_SISVAN/Dados/gestantes",as.character(y),".csv", collapse = NULL) 
